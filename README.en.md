...
Palmos is released under the [MIT License](LICENSE), which is also included in the app bundle.

### Third-Party Licenses

Palmos uses [MenuBarExtraAccess 1.3.0](https://github.com/orchetect/MenuBarExtraAccess), which is distributed under the MIT License. The complete license is available at [`Shared/Licensing/MenuBarExtraAccess-LICENSE.txt`](Shared/Licensing/MenuBarExtraAccess-LICENSE.txt) and is included in the app bundle.
