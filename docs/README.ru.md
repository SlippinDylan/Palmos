...
По умолчанию Palmos следует языку приложения в macOS. В разделе **Настройки → Основные** можно явно выбрать English, 简体中文 или 繁體中文; после смены языка приложение необходимо перезапустить.
