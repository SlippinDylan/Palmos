...
actor HelperOccupancyEndpoint {
    ...
    func handle(_ requestData: Data) async -> HelperOccupancyEndpointResult {
        ...
        do {
            ...
            request = try PalmosXPCMessages.decodeOccupancyRequest(from: requestData)
        ...
        do {
            ...
            case let .response(response):
                return HelperOccupancyEndpointResult(
                    data: try PalmosXPCMessages.encodeOccupancyResponse(response),
                    error: nil
                )
            case .incomplete:
                return HelperOccupancyEndpointResult(
                    data: try PalmosXPCMessages.encodeOccupancyResponse(
