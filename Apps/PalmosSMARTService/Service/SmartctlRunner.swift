...
final class SmartctlRunner: SMARTDataRunning, @unchecked Sendable {
    ...
    static let trustedExecutablePath = "/Library/PrivilegedHelperTools/com.palmos.smartservice.smartctl"
    static let trustedExecutableIdentifier = "com.palmos.smartservice.smartctl"
