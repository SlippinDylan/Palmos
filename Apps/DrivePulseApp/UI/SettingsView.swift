...
private struct GeneralSettingsPane: View {
    ...
    var body: some View {
        SettingsPane(
            title: "General",
            subtitle: "Choose how DrivePulse behaves on this Mac."
        ) {
            SettingsCard {
                SettingsControlRow(
                ...
                SettingsControlRow(
                    ...
                    subtitle: "DrivePulse can launch automatically when you sign in.",
                    systemImage: "power"
                ) {
                    Toggle(
                        "Launch at Login",
    ...
    init(status: SMARTHelperStatus) {
        ...
        case .checking:
            self.init(
                ...
                message: "DrivePulse is checking the installed helper.",
        ...
        case .updateRequired:
            self.init(
                ...
                message: "Update the helper to match this version of DrivePulse.",
        ...
        case .inspectionFailed(let error):
            self.init(
                ...
                message: "DrivePulse could not verify the SMART helper.",
