...
final class SafeEjectIntegrationTests: XCTestCase {
    ...
    func testPalmosOwnedIOIsDrainedBeforeUnmountAndIsNotReportedAsHolder() async throws {
        ...
        XCTAssertFalse(coordinator.state.recovery?.holders.contains { $0.preferredName == "Palmos" } == true)
    }
